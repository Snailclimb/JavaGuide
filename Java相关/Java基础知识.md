...
- [Java 基础知识30问](#java-基础知识30问)
    ...
    - [21. 一个类的构造方法的作用是什么？若一个类没有声明构造方法，改程序能正确执行吗？为什么？](#21-一个类的构造方法的作用是什么？若一个类没有声明构造方法，改程序能正确执行吗？为什么？)
...
1. 在外部调用静态方法时，只能采用"类名.方法名"的方式，实例方法只能采用"对象名.方法名"的方式。也就是说，调用静态方法可以无需创建对象。 
