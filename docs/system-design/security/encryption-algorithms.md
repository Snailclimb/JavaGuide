...
![DES（Data Encryption Standard）](/oss/github/javaguide/system-design/security/des-steps.jpg)
...
![AES（Advanced Encryption Standard）](/oss/github/javaguide/system-design/security/aes-steps.jpg)
...
![DES 和 AES 对比](/oss/github/javaguide/system-design/security/des-vs-aes.png)
...
![HTTPS 证书签名算法中带RSA 加密的SHA-256 ](/oss/github/javaguide/system-design/security/encryption-algorithms/https-rsa-sha-256.png)
...
![DSA 算法签名过程](/oss/github/javaguide/system-design/security/encryption-algorithms/dsa-algorithm-signing-process.png)
