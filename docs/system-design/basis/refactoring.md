...
![](/oss/github/javaguide/image-20220311155746549.png)
...
![常见的设计模式](/oss/github/javaguide/system-design/basis/common-design-patterns.png)

更全面的设计模式总结，可以看 **[java-design-patterns](https://github.com/iluwatar/java-design-patterns)** 这个开源项目。

**常见的软件设计原则如下**：

![常见的软件设计原则](/oss/github/javaguide/system-design/basis/programming-principles.png)
...
![](/oss/github/javaguide/bad&good-design.png)
...
![refractor-two-hats](/oss/github/javaguide/refractor-two-hats.png)
