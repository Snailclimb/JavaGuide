...
![](/oss/javaguide/20210607154324712.png)
...
![BlockingQueue 的实现类](/oss/github/javaguide/java/collection/blocking-queue-hierarchy.png)
...
![](/oss/github/javaguide/system-design/schedule-task/one-layers-of-time-wheel.png)
...
![](/oss/github/javaguide/system-design/schedule-task/three-layers-of-time-wheel.png)
...
![](/oss/github/javaguide/system-design/schedule-task/elasticjob-feature-list.png)

ElasticJob-Lite 的架构设计如下图所示：

![ElasticJob-Lite 的架构设计](/oss/github/javaguide/system-design/schedule-task/elasticjob-lite-architecture-design.png)
...
![](/oss/github/javaguide/system-design/schedule-task/xxljob-feature-list.png)
...
![](/oss/github/javaguide/system-design/schedule-task/xxljob-architecture-design-v2.1.0.png)
...
![](/oss/github/javaguide/system-design/schedule-task/xxljob-admin-task-management.png)
