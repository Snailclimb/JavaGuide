...
![](/oss/github/javaguide/high-performance/message-queue/16ef37fee7e09230.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef380429cf373e.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef38124f55eaea.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef381a505d3e1f.jpg)

那么第二步，我们又添加了一个发送邮件，我们就得重新去修改代码，如果我们又加一个需求：用户购买完还需要给他加积分，这个时候我们是不是又得改代码？

![](/oss/github/javaguide/high-performance/message-queue/16ef381c4e1b1ac7.jpg)

如果还觉得可以接受，那么当需要移除发送邮件服务时，是不是又得改代码、又得重启应用？

![](/oss/github/javaguide/high-performance/message-queue/16ef381f273a66bd.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef382674b66892.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef382a9756bb1c.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef382d709abc9d.png)

下面我们逐一讨论这些问题的解决方案。

## RocketMQ 是什么？

![RocketMQ 官网介绍](/oss/github/javaguide/high-performance/message-queue/16ef383014430799.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef3834ae653469.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef3837887d9a54sds.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef383d3e8c9788.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef3850c808d707.jpg)

**每个消费组在每个队列上维护一个消费位置** ，为什么呢？

因为我们刚刚画的仅仅是一个消费者组，我们知道在发布订阅模式中一般会涉及到多个消费者组，而每个消费者组在每个队列中的消费位置都是不同的。如果此时有多个消费者组，那么消息被一个消费者组消费完之后是不会删除的(因为其它消费者组也需要呀)，它仅仅是为每个消费者组维护一个 **消费位移(offset)** ，每次消费者组消费完会返回一个成功的响应，然后队列再把维护的消费位移加一，这样就不会出现刚刚消费过的消息再一次被消费了。

![](/oss/github/javaguide/high-performance/message-queue/16ef3857fefaa079.jpg)

可能你还有一个问题，**为什么一个主题中需要维护多个队列** ？

答案是 **提高并发能力** 。的确，每个主题中只存在一个队列也是可行的。你想一下，如果每个主题中只存在一个队列，这个队列中也维护着每个消费者组的消费位置，这样也可以做到 **发布订阅模式** 。如下图。

![](/oss/github/javaguide/high-performance/message-queue/16ef38600cdb6d4b.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef38687488a5a4.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef386c6d1e8bdb.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef386fa3be1e53.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef3874585e096e.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef38798d7a987f.png)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef387d939ab66d.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/31699457085_.pic.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/41699457086_.pic.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/51699457087_.pic.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef387fba311cda-20230814005009889.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef38687488a5asadasfg4.jpg)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef3884c02acc72.png)
...
![](/oss/github/javaguide/high-performance/message-queue/16ef388763c25c62.jpg)
