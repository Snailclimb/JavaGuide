...
![](/oss/github/javaguide/high-performance/message-queue/disruptor-interview-questions.png)
...
![](/oss/github/javaguide/high-performance/message-queue/640.png)
...
![2011 年的 Oracle 官方的 Duke's Choice Awards](/oss/javaguide/image-20211015152323898.png)
...
![disruptor-latency-histogram](/oss/github/javaguide/high-performance/message-queue/disruptor-latency-histogram.png)
...
![LMAX 系统使用 Disruptor 的示例](/oss/github/javaguide/high-performance/message-queue/disruptor-models.png)
...
![Disruptor 等待策略](/oss/github/javaguide/high-performance/message-queue/DisruptorWaitStrategy.png)
