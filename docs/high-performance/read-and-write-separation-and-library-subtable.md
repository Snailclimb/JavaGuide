...
![读写分离示意图](/oss/github/javaguide/high-performance/read-and-write-separation-and-library-subtable/read-and-write-separation.png)
...
![代理方式实现读写分离](/oss/github/javaguide/high-performance/read-and-write-separation-and-library-subtable/read-and-write-separation-proxy.png)
...
![MySQL主从复制](/oss/java-guide-blog/78816271d3ab52424bfd5ad3086c1a0f.png)
...
![ShardingSphere 提供的功能](/oss/github/javaguide/high-performance/shardingsphere-features.png)
