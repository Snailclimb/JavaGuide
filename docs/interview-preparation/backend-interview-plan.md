...
- **微服务**（岗位或项目涉及再重点看）：[微服务面试准备](https://javaguide.cn/distributed-system/microservices-interview-questions.html)，再按项目补 RPC、网关、配置中心、分布式事务和高可用。
