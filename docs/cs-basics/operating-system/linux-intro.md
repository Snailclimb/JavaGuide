...
![Linux 之父](./images/generated/linux-father.png)
...
![OPINION: Make the switch to a Linux operating system | Opinion ...](./images/generated/Linux-Logo.png)
...
![ Linux 命令快查](./images/generated/linux-command-search.png)

另外，[shell.how](https://www.shell.how/) 这个网站可以用来解释常见命令的意思，对你学习 Linux 基本命令以及其他常用命令（如 Git、NPM）。

![shell.how 使用示例](./images/generated/shell-now.png)
