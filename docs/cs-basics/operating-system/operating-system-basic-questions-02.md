...
![内存管理主要做的事情](/oss/github/javaguide/cs-basics/operating-system/memory-management-roles.png)
...
![内存碎片](/oss/github/javaguide/cs-basics/operating-system/internal-and-external-fragmentation.png)
...
![伙伴系统（Buddy System）内存管理](/oss/github/javaguide/cs-basics/operating-system/linux-buddy-system.png)
...
![伙伴系统内存浪费问题](/oss/github/javaguide/cs-basics/operating-system/buddy-system-memory-waste.png)
...
![虚拟内存作为进程访问主存的桥梁](/oss/xingqiu/virtual-memory.png)
...
![地址翻译过程](/oss/github/javaguide/cs-basics/operating-system/physical-virtual-address-translation.png)
...
![分段机制下的地址翻译过程](/oss/github/javaguide/cs-basics/operating-system/segment-virtual-address-composition.png)
...
![分段机制导致外部内存碎片](/oss/github/javaguide/cs-basics/operating-system/segment-external-memory-fragmentation.png)
...
![单级页表](/oss/github/javaguide/cs-basics/operating-system/page-table.png)
...
![分页机制下的地址翻译过程](/oss/github/javaguide/cs-basics/operating-system/paging-virtual-address-composition.png)
...
![多级页表](/oss/github/javaguide/cs-basics/operating-system/multilevel-page-table.png)
...
![使用 TLB 之后的地址翻译流程](/oss/github/javaguide/cs-basics/operating-system/page-table-tlb.png)
...
![常见的页面置换算法](/oss/github/javaguide/cs-basics/operating-system/image-20230409113009139.png)
...
![常见的磁盘调度算法](/oss/github/javaguide/cs-basics/operating-system/disk-scheduling-algorithms.png)
