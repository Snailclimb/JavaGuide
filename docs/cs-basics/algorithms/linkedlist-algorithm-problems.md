...
![图1，对两数相加方法的可视化: 342 + 465 = 807， 每个结点都包含一个数字，并且数字按位逆序存储。](./images/generated/34910956.jpg)
...
![翻转链表](./images/generated/81431871.jpg)
...
![图 1. 删除列表中的第 L - n + 1 个元素](./images/generated/94354387.jpg)
