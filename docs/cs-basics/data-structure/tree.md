...
![二叉树](/oss/github/javaguide/cs-basics/data-structure/%E4%BA%8C%E5%8F%89%E6%A0%91-2.png)
...
![危机百科对节点深度的定义](/oss/github/javaguide/image-20220119112736158.png)

### 满二叉树

一个二叉树，如果每一个层的结点数都达到最大值，则这个二叉树就是 **满二叉树**。也就是说，如果一个二叉树的层数为 K，且结点总数是(2^k) -1 ，则它就是 **满二叉树**。如下图所示：

![满二叉树](/oss/github/javaguide/cs-basics/data-structure/full-binary-tree.png)
...
![完全二叉树](/oss/github/javaguide/cs-basics/data-structure/complete-binary-tree.png)
...
![斜树](/oss/github/javaguide/cs-basics/data-structure/oblique-tree.png)
...
![平衡二叉树](/oss/github/javaguide/cs-basics/data-structure/balanced-binary-tree.png)
...
![链式存储二叉树](/oss/github/javaguide/cs-basics/data-structure/chain-store-binary-tree.png)
...
![完全二叉树的数组顺序存储](/oss/github/javaguide/cs-basics/data-structure/sequential-storage.png)

大家可以试着填写一下存储如下二叉树的数组，比较一下和完全二叉树的顺序存储有何区别：

![非完全二叉树的数组顺序存储](/oss/github/javaguide/cs-basics/data-structure/sequential-storage2.png)
...
![先序遍历](/oss/github/javaguide/cs-basics/data-structure/preorder-traversal.png)
...
![中序遍历](/oss/github/javaguide/cs-basics/data-structure/inorder-traversal.png)

二叉树的中序遍历，就是先递归中序遍历左子树，再输出根结点的值，再递归中序遍历右子树，大家可以想象成一巴掌把树压扁，父结点被拍到了左子节点和右子节点的中间，如下图所示：

![中序遍历](/oss/github/javaguide/cs-basics/data-structure/inorder-traversal2.png)
...
![后序遍历](/oss/github/javaguide/cs-basics/data-structure/postorder-traversal.png)
