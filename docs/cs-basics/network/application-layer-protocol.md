...
![](/oss/github/javaguide/450px-HTTP-Header.png)
...
![SMTP 协议](/oss/github/javaguide/cs-basics/network/what-is-smtp.png)
...
![FTP工作过程](/oss/github/javaguide/cs-basics/network/ftp.png)
...
![Telnet:远程登陆协议](/oss/github/javaguide/cs-basics/network/Telnet_is_vulnerable_to_eavesdropping-2.png)
...
![SSH:安全的网络传输协议](/oss/github/javaguide/cs-basics/network/ssh-client-server.png)
