...
![OSI 七层模型](/oss/github/javaguide/cs-basics/network/osi-7-model.png)
...
![osi七层模型2](/oss/github/javaguide/osi%E4%B8%83%E5%B1%82%E6%A8%A1%E5%9E%8B2.png)
...
![TCP/IP 四层模型](/oss/github/javaguide/cs-basics/network/tcp-ip-4-model.png)
...
![应用层常见协议](/oss/github/javaguide/cs-basics/network/application-layer-protocol.png)
...
![传输层常见协议](/oss/github/javaguide/cs-basics/network/transport-layer-protocol.png)
...
<img src="/oss/github/javaguide/url%E8%BE%93%E5%85%A5%E5%88%B0%E5%B1%95%E7%A4%BA%E5%87%BA%E6%9D%A5%E7%9A%84%E8%BF%87%E7%A8%8B.jpg" style="zoom:50%" />
...
![常见 HTTP 状态码](/oss/github/javaguide/cs-basics/network/http-status-code.png)
...
![HTTP 和 HTTPS 对比](/oss/github/javaguide/cs-basics/network/http-vs-https.png)
...
![HTTP/1.0 和 HTTP/1.1 对比](/oss/github/javaguide/cs-basics/network/http1.0-vs-http1.1.png)
...
![HTTP/1.0 和 HTTP/1.1 对比](/oss/github/javaguide/cs-basics/network/http1.1-vs-http2.0.png)
...
![HTTP/2 Multiplexing](/oss/github/javaguide/cs-basics/network/http2.0-multiplexing.png)
...
![HTTP/2.0 和 HTTP/3.0 对比](/oss/github/javaguide/cs-basics/network/http2.0-vs-http3.0.png)
...
![http-3-implementation](/oss/github/javaguide/cs-basics/network/http-3-implementation.png)

下图是一个更详细的 HTTP/2.0 和 HTTP/3.0 对比图：

![HTTP/2.0 和 HTTP/3.0 详细对比图](/oss/github/javaguide/cs-basics/network/http2-and-http3-stacks-comparison.png)
...
![](/oss/github/javaguide/system-design/security/session-cookie-authentication-process.png)
...
![ JWT 身份验证示意图](/oss/github/javaguide/system-design/jwt/jwt-authentication%20process.png)
...
![Websocket 示意图](/oss/github/javaguide/system-design/web-real-time-message-push/1460000042192394.png)
...
![DeepSeek 响应标头](/oss/github/javaguide/cs-basics/network/deepseek-sse.png)

![](/oss/github/javaguide/cs-basics/network/deepseek-sse-eventstream.png)
...
![DNS:域名系统](/oss/github/javaguide/cs-basics/network/dns-overview.png)
