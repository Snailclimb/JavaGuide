...
![IP 地址使数据包到达其目的地](/oss/github/javaguide/cs-basics/network/internet_protocol_ip_address_diagram.png)
...
![IPv4](/oss/github/javaguide/cs-basics/network/Figure-1-IPv4Addressformatwithdotteddecimalnotation-29c824f6a451d48d8c27759799f0c995.png)
...
![IPv6](/oss/github/javaguide/cs-basics/network/Figure-2-IPv6Addressformatwithhexadecimalnotation-7da3a419bd81627a9b2cef3b0efb4940.png)
...
![NAT 实现 IP地址转换](/oss/github/javaguide/cs-basics/network/network-address-translation.png)
...
![路由器的背面就会注明 MAC 位址](/oss/github/javaguide/cs-basics/network/router-back-will-indicate-mac-address.png)
