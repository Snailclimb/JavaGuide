...
![Root-Servers.org](/oss/github/javaguide/cs-basics/network/root-servers-org.png)
...
![](/oss/github/javaguide/cs-basics/network/DNS-process.png)
...
![](/oss/github/javaguide/cs-basics/network/DNS-process2.png)
...
![](/oss/github/javaguide/cs-basics/network/DNS-packet.png)
...
![](/oss/github/javaguide/cs-basics/network/20210506174303797.png)

`TTL`是该记录的生存时间，它决定了资源记录应当从缓存中删除的时间。

`Name`和`Value`字段的取值取决于`Type`：

![](/oss/github/javaguide/cs-basics/network/20210506170307897.png)
