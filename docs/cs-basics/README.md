---
title: 计算机基础知识总结
description: 计算机基础常见知识点&面试题总结，涵盖计算机网络、操作系统、数据结构与算法等核心知识，配有大量图解。
...
这个专栏把网络、操作系统、数据结构与算法的高频考点系统整理了出来，整站配有 **280+ 张技术配图**，用图解的方式把抽象概念讲清楚，不是干巴巴的文字堆砌。

## 网络

网络部分按协议层组织，从面试题到各层核心知识点，层层递进。
...
每篇都配有大量图解，把数据结构的形态和操作过程画出来，比纯文字好理解得多。
