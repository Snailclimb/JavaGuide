...
![Token 化过程示例](/oss/github/javaguide/ai/llm/llm-token-process.png)
...
![上下文窗口（Context Window）= LLM 的「工作记忆」](/oss/github/javaguide/ai/llm/llm-context-window.png)
...
![Temperature 参数：控制模型输出的随机性](/oss/github/javaguide/ai/llm/llm-temperature-params.png)
