...
![Agent = Model + Harness](/oss/github/javaguide/ai/harness/harness-agent-equals-model-harness-arch.png)

### Harness 和 Prompt/Context Engineering 是什么关系？

三者不是并列关系，而是嵌套关系。更重要的是，**每一层解决的是完全不同的问题**：

![Harness 和 Prompt/Context Engineering 的关系](/oss/github/javaguide/ai/harness/harness-engineering-layers-arch.png)
...
![Harness Engineering 六层架构](/oss/github/javaguide/ai/harness/harness-engineering-six-layer-architecture.svg)
...
![上下文利用率的 40% 阈值现象](/oss/github/javaguide/ai/harness/context-utilization-40-percent-threshold-phenomenon.svg)
...
![Anthropic 三智能体协同架构 (受 GAN 启发)](/oss/github/javaguide/ai/harness/anthropic-three-agent-collaborative-architecture-inspired-by-gan.svg)
...
![Stripe 混合状态机编排架构](/oss/github/javaguide/ai/harness/stripe-hybrid-state-machine-orchestration-architecture.svg)
...
![持续进化的 Harness 防错反馈闭环](/oss/github/javaguide/ai/harness/continuously-evolving-harness-error-prevention-feedback-loop.svg)
