...
![AI Agent 核心架构](/oss/github/javaguide/ai/agent/agent-core-arch.png)
...
![Agent Loop 工作流程](/oss/github/javaguide/ai/agent/agent-loop-flow.png)
...
![ReAct-LLM](/oss/github/javaguide/ai/agent/ReAct-LLM.png)
...
![ReAct 模式流程](/oss/github/javaguide/ai/agent/agent-react-flow.png)
...
![Multi-Agent 系统架构（Orchestrator-Subagent 模式）](/oss/github/javaguide/ai/agent/agent-multi-agent-arch.png)
...
![A2A (Agent-to-Agent) 通信协议架构](/oss/github/javaguide/ai/agent/agent-a2a.png)
...
![ Agentic Workflows（智能体工作流）核心模式](/oss/github/javaguide/ai/agent/agent-agentic-workflows.png)
