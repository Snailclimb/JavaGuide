...
![RAG 场景为什么需要向量数据库？](/oss/github/javaguide/ai/rag/rag-why-need-vector-store.png)
...
![向量索引算法分类](/oss/github/javaguide/ai/rag/rag-vector-index-algorithms.png)
...
![HNSW 索引架构](/oss/github/javaguide/ai/rag/rag-hnsw-architecture.png)
...
![VECTOR 列不能用作任何类型的键，包括主键、外键、唯一键和分区键](/oss/github/javaguide/ai/rag/mysql9-vector-cannot-be-used-as-any-type-of-key.png)
