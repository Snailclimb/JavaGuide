...
> 这里以 [《SpringAI 智能面试平台+RAG 知识库》](https://mp.weixin.qq.com/s/q9UjF53OG0rQVQu92UOKlQ)项目为例。
...
这里以 [《SpringAI 智能面试平台+RAG 知识库》](https://mp.weixin.qq.com/s/q9UjF53OG0rQVQu92UOKlQ)项目为例。本项目需要同时存储结构化数据（简历、面试记录）和向量数据（文档 Embedding）。
