...
![RAG 示意图](/oss/github/javaguide/ai/rag/rag-simplified-architecture-diagram.jpeg)

## ⭐️ 为什么需要 RAG？

![RAG（检索增强生成）如何解决 LLM 的核心挑战](/oss/github/javaguide/ai/rag/rag-llm-challenges.png)
...
![RAG 与传统搜索引擎的区别](/oss/github/javaguide/ai/rag/rag-rag-vs-search-engine.png)
