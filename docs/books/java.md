...
![《Head First Java》-豆瓣](/oss/github/javaguide/books/image-20220424103035793.png)
...
![《Java 核心技术卷 1》-豆瓣](/oss/github/javaguide/books/image-20220424101217849.png)
...
![《Java编程的逻辑》](/oss/github/javaguide/books/image-20230721153650488.png)
...
![《Java 并发编程之美》-豆瓣](/oss/github/javaguide/books/image-20220424112413660.png)
...
![《实战 Java 高并发程序设计》-豆瓣](/oss/github/javaguide/books/image-20220424112554830.png)
...
![《深入浅出 Java 多线程》在线阅读](/oss/github/javaguide/books/image-20220424112927759.png)
...
![《Java 并发实现原理：JDK 源码剖析》-豆瓣](/oss/github/javaguide/books/0b1b046af81f4c94a03e292e66dd6f7d.png)
...
![《深入理解 Java 虚拟机》-豆瓣](/oss/github/javaguide/books/20210710104655705.png)
...
![《实战 Java 虚拟机》-豆瓣](/oss/github/javaguide/books/image-20220424113158144.png)

![《虚拟机设计与实现:以 JVM 为例》-豆瓣](/oss/github/javaguide/books/image-20220424113210153.png)

如果你对实战比较感兴趣，想要自己动手写一个简易的 JVM 的话，可以看看 **[《自己动手写 Java 虚拟机》](https://book.douban.com/subject/26802084/)** 这本书。

![《自己动手写 Java 虚拟机》-豆瓣](/oss/github/javaguide/books/image-20220424113445246.png)
...
![《Spring 实战》-豆瓣](/oss/github/javaguide/books/image-20220424113512453.png)
...
![](/oss/github/javaguide/books/20210328171223638.png)
...
![《Spring Boot 编程思想（核心篇）》-豆瓣](/oss/github/javaguide/books/image-20220424113546513.png)
...
![《Spring Boot 实战》-豆瓣](/oss/github/javaguide/books/image-20220424113614768.png)
...
![《手写MyBatis：渐进式源码实践》](/oss/github/javaguide/books/image-20230724123402784.png)
...
![《通用源码阅读指导书――MyBatis源码详解》](/oss/github/javaguide/books/image-20230724123416741.png)
...
![《Netty 实战》-豆瓣](/oss/github/javaguide/books/image-20220424113715369.png)
...
![《Netty 进阶之路：跟着案例学 Netty》-豆瓣](/oss/github/javaguide/books/image-20220424113747345.png)
...
![](/oss/github/javaguide/open-source-project/image-20220503085034268.png)
...
![《Java 性能权威指南》-豆瓣](/oss/github/javaguide/books/image-20220424113809644.png)
...
![](/oss/github/javaguide/books/20210412224443177.png)

《从零开始学架构》这本书对应的有一个极客时间的专栏—《从零开始学架构》，里面的很多内容都是这个专栏里面的，两者买其一就可以了。我看了很小一部分，内容挺全面的，是一本真正在讲如何做架构的书籍。

![](/oss/github/javaguide/books/20210412232441459.png)
...
![](/oss/github/javaguide-mianshituji/image-20220830103023493.png)

![](/oss/github/javaguide-mianshituji/image-20220830102925775.png)
