...
![通过github-readme-stats动态生成GitHub统计信息 ](/oss/java-guide-blog/image-20210616221312426.png)
...
![项目徽章](/oss/2020-11/image-20201107143136559.png)

并且，你不光可以生成静态徽章，shield.io 还可以动态读取你项目的状态并生成对应的徽章。

![自定义项目徽章](/oss/2020-11/image-20201107143502356.png)

生成的描述项目状态的徽章效果如下图所示。

![描述项目状态的徽章](/oss/2020-11/image-20201107143752642.png)
...
![Chrome插件Octotree](/oss/2020-11/image-20201107144944798.png)
...
![](/oss/2020-11/image-20201107160817672.png)
...
![](</oss/2020-11/iShot2020-11-07%2016.14.14%20(1).png>)
...
![](/oss/github/javaguide/github-explore.png)
...
![](/oss/github/javaguide/image-20211227100147433.png)
