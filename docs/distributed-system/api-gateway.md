...
![网关示意图](/oss/github/javaguide/system-design/distributed-system/api-gateway-overview.png)
...
![基于 Nginx 的服务端负载均衡](/oss/github/javaguide/high-performance/load-balancing/server-load-balancing.png)
...
![](/oss/github/javaguide/distributed-system/api-gateway/up-35e102c633bbe8e0dea1e075ea3fee5dcfb.png)
...
![Zuul 核心架构](/oss/github/javaguide/distributed-system/api-gateway/zuul-core-architecture.webp)

Zuul 主要通过过滤器（类似于 AOP）来过滤请求，从而实现网关必备的各种功能。

![Zuul 请求声明周期](/oss/github/javaguide/system-design/distributed-system/api-gateway/zuul-request-lifecycle.webp)
...
![Zuul2 架构](/oss/github/javaguide/distributed-system/api-gateway/zuul2-core-architecture.png)
...
![OpenResty 和 Nginx 以及 Lua 的关系](/oss/github/javaguide/system-design/distributed-system/api-gatewaynginx-lua-openresty.png)
...
![](/oss/github/javaguide/system-design/distributed-system/api-gateway/kong-way.webp)
...
![](/oss/github/javaguide/system-design/distributed-system/api-gateway/kong-gateway-overview.png)
...
![APISIX 架构图](/oss/github/javaguide/distributed-system/api-gateway/apisix-architecture.png)
...
![](/oss/github/javaguide/distributed-system/api-gateway/up-a240d3b113cde647f5850f4c7cc55d4ff5c.png)
...
![Shenyu 架构](/oss/github/javaguide/distributed-system/api-gateway/shenyu-architecture.png)
