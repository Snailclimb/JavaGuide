...
![ZooKeeper 数据模型](/oss/github/javaguide/distributed-system/zookeeper/znode-structure.png)
...
![ZooKeeper Watcher 机制](/oss/github/javaguide/distributed-system/zookeeper/zookeeper-watcher.png)
...
![ZooKeeper 集群架构](/oss/github/javaguide/distributed-system/zookeeper/zookeeper-cluster.png)
...
![ZooKeeper 集群中角色](/oss/github/javaguide/distributed-system/zookeeper/zookeeper-cluser-roles.png)
