...
![共享资源未互斥访问导致出现问题](/oss/github/javaguide/distributed-system/distributed-lock/oversold-without-locking.png)
...
![本地锁](/oss/github/javaguide/distributed-system/distributed-lock/jvm-local-lock.png)
...
![分布式锁](/oss/github/javaguide/distributed-system/distributed-lock/distributed-lock.png)
