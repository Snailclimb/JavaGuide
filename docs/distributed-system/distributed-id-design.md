...
![文库会员支付示例](/oss/github/javaguide/system-design/distributed-system/distributed-id-design-pay-one-card.png)
...
![优惠编码兑换奖品](/oss/github/javaguide/system-design/distributed-system/distributed-id-design-coupon.png)
...
![在分布式链路跟踪](/oss/github/javaguide/system-design/distributed-system/distributed-id-design-tracing.png)
...
![短网址作用](/oss/github/javaguide/system-design/distributed-system/distributed-id-design-short-url.png)
