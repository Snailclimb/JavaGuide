...
![一个类的完整生命周期](./images/generated/lifecycle-of-a-class.png)
...
![验证阶段示意图](./images/generated/class-loading-process-verification.png)
...
![基本数据类型的零值](./images/generated/基本数据类型的零值.png)
