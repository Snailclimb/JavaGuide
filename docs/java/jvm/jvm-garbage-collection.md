...
![堆内存结构](./images/generated/hotspot-heap-structure.png)
...
通过以下方式运行：
![](./images/generated/25178350.png)

添加的参数：`-XX:+PrintGCDetails`
![](./images/generated/run-with-PrintGCDetails.png)

运行结果 (红色字体描述有误，应该是对应于 JDK1.7 的永久代)：

![](./images/generated/28954286.jpg)
...
>
![](./images/generated/image-20210523201742303.png)
>
> **动态年龄计算的代码如下：**
>
> ```c++
...
![R 大的回答](./images/generated/rf-hotspot-vm-gc.png)
...
![对象之间循环引用](./images/generated/object-circular-reference.png)
...
![可达性分析算法](./images/generated/jvm-gc-roots.png)
...
![Java 引用类型总结](./images/generated/java-reference-type.png)
...
![标记-清除算法](./images/generated/mark-and-sweep-garbage-collection-algorithm.png)
...
![复制算法](./images/generated/copying-garbage-collection-algorithm.png)
...
![标记-整理算法](./images/generated/mark-and-compact-garbage-collection-algorithm.png)
...
![Serial 收集器](./images/generated/serial-garbage-collector.png)
...
![ParNew 收集器 ](./images/generated/parnew-garbage-collector.png)
...
![Parallel Old收集器运行示意图](./images/generated/parallel-scavenge-garbage-collector.png)
...
![CMS 收集器](./images/generated/cms-garbage-collector.png)
...
![G1 收集器](./images/generated/g1-garbage-collector.png)
