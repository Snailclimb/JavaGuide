...
通过以下方式运行：
![](/oss/github/javaguide/java/jvm/25178350.png)

添加的参数：`-XX:+PrintGCDetails`
![](/oss/github/javaguide/java/jvm/run-with-PrintGCDetails.png)

运行结果 (红色字体描述有误，应该是对应于 JDK1.7 的永久代)：

![](/oss/github/javaguide/java/jvm/28954286.jpg)
...
![](/oss/github/javaguide/java/jvm/28128785.jpg)
...
>
> ![](/oss/java-guide-blog/image-20210523201742303.png)
>
> **动态年龄计算的代码如下：**
>
> ```c++
...
![R 大的回答](/oss/github/javaguide/java/jvm/rf-hotspot-vm-gc.png)
...
![对象之间循环引用](/oss/github/javaguide/java/jvm/object-circular-reference.png)
...
![可达性分析算法](/oss/github/javaguide/java/jvm/jvm-gc-roots.png)
...
![Java 引用类型总结](/oss/github/javaguide/java/jvm/java-reference-type.png)
...
![标记-清除算法](/oss/github/javaguide/java/jvm/mark-and-sweep-garbage-collection-algorithm.png)
...
![复制算法](/oss/github/javaguide/java/jvm/copying-garbage-collection-algorithm.png)
...
![标记-整理算法](/oss/github/javaguide/java/jvm/mark-and-compact-garbage-collection-algorithm.png)
...
![Serial 收集器](/oss/github/javaguide/java/jvm/serial-garbage-collector.png)
...
![ParNew 收集器 ](/oss/github/javaguide/java/jvm/parnew-garbage-collector.png)
...
![Parallel Old收集器运行示意图](/oss/github/javaguide/java/jvm/parallel-scavenge-garbage-collector.png)
...
![CMS 收集器](/oss/github/javaguide/java/jvm/cms-garbage-collector.png)
...
![G1 收集器](/oss/github/javaguide/java/jvm/g1-garbage-collector.png)
