...
![Java 运行时数据区域（JDK1.7）](/oss/github/javaguide/java/jvm/java-runtime-data-areas-jdk1.7.png)

**JDK 1.8**：

![Java 运行时数据区域（JDK1.8 ）](/oss/github/javaguide/java/jvm/java-runtime-data-areas-jdk1.8.png)
...
![Java 虚拟机栈](/oss/github/javaguide/java/jvm/stack-area.png)

**局部变量表** 主要存放了编译期可知的各种数据类型（boolean、byte、char、short、int、float、long、double）、对象引用（reference 类型，它不同于对象本身，可能是一个指向对象起始地址的引用指针，也可能是指向一个代表对象的句柄或其他与此对象相关的位置）。

![局部变量表](/oss/github/javaguide/java/jvm/local-variables-table.png)
...
![](/oss/github/javaguide/jvmimage-20220331175738692.png)
...
![](/oss/github/javaguide/java/jvm/%E3%80%8A%E6%B7%B1%E5%85%A5%E7%90%86%E8%A7%A3%E8%99%9A%E6%8B%9F%E6%9C%BA%E3%80%8B%E7%AC%AC%E4%B8%89%E7%89%88%E7%9A%84%E7%AC%AC2%E7%AB%A0-%E8%99%9A%E6%8B%9F%E6%9C%BA%E6%A0%88.png)
...
![堆内存结构](/oss/github/javaguide/java/jvm/hotspot-heap-structure.png)
...
![标记字段结构](/oss/github/javaguide/java/jvm/hotspot-markOop.hpp..png)
...
![method-area-jdk1.7](/oss/github/javaguide/java/jvm/method-area-jdk1.7.png)

**方法区和永久代以及元空间是什么关系呢？** 方法区和永久代以及元空间的关系很像 Java 中接口和类的关系，类实现了接口，这里的类就可以看作是永久代和元空间，接口可以看作是方法区，也就是说永久代以及元空间是 HotSpot 虚拟机对虚拟机规范中方法区的两种实现方式。并且，永久代是 JDK 1.8 之前的方法区实现，JDK 1.8 及以后方法区的实现变成了元空间。

![HotSpot 虚拟机方法区的两种实现](/oss/github/javaguide/java/jvm/method-area-implementation.png)

**为什么要将永久代 (PermGen) 替换为元空间 (MetaSpace) 呢?**

下图来自《深入理解 Java 虚拟机》第 3 版 2.2.5

![](/oss/github/javaguide/java/jvm/20210425134508117.png)
...
![符号引用和直接引用](/oss/github/javaguide/java/jvm/symbol-reference-and-direct-reference.png)
...
![method-area-jdk1.6](/oss/github/javaguide/java/jvm/method-area-jdk1.6.png)
...
![对象的访问定位-使用句柄](/oss/github/javaguide/java/jvm/access-location-of-object-handle.png)

#### 直接指针

如果使用直接指针访问，reference 中存储的直接就是对象的地址。

![对象的访问定位-直接指针](/oss/github/javaguide/java/jvm/access-location-of-object-handle-direct-pointer.png)
