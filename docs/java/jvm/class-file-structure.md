...
![ClassFile 内容分析](./images/generated/16d5ec47609818fc.jpeg)

下面这张图是通过 IDEA 插件 `jclasslib` 查看的，你可以更直观看到 Class 文件结构。

![](./images/generated/image-20210401170711475.png)
...
![类访问和属性修饰符](./images/generated/访问标志.png)
...
![查看类的访问标志](./images/generated/查看类的访问标志.png)
...
![字段表的结构 ](./images/generated/字段表的结构.png)
...
![字段的 access_flag 的取值](./images/generated/image-20201031084342859.png)
...
![方法表的结构](./images/generated/方法表的结构.png)

**方法表的 access_flag 取值：**

![方法表的 access_flag 取值](./images/generated/image-20201031084248965.png)
