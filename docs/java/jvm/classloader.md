...
![类加载过程](/oss/github/javaguide/java/jvm/class-loading-procedure.png)
...
![类加载器层次关系图](/oss/github/javaguide/java/jvm/class-loader-parents-delegation-model.png)
...
![Tomcat 的类加载器的层次结构](/oss/github/javaguide/java/jvm/tomcat-class-loader-parents-delegation-model.png)
