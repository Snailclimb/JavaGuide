...
![Java 7 ConcurrentHashMap 存储结构](/oss/github/javaguide/java/collection/java7_concurrenthashmap.png)
...
![Java8 ConcurrentHashMap 存储结构（图片来自 javadoop）](/oss/github/javaguide/java/collection/java8_concurrenthashmap.png)
