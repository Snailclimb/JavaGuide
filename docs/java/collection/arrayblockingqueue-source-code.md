...
![ArrayBlockingQueue 类图](/oss/github/javaguide/java/collection/arrayblockingqueue-class-diagram.png)
...
![ArrayBlockingQueue 非空条件](/oss/github/javaguide/java/collection/ArrayBlockingQueue-notEmpty-take.png)
...
![ArrayBlockingQueue 非满条件](/oss/github/javaguide/java/collection/ArrayBlockingQueue-notFull-put.png)
...
![ArrayBlockingQueue 非空非满](/oss/github/javaguide/java/collection/ArrayBlockingQueue-notEmpty-notFull.png)
...
![](/oss/github/javaguide/java/collection/ArrayBlockingQueue-get-add-element-methods.png)
