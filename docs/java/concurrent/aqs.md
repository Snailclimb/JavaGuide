...
![AQS 独占模式获取锁](/oss/github/javaguide/java/concurrent/aqs-exclusive-mode-acquire-lock.png)
...
![](/oss/github/javaguide/java/concurrent/clh-queue-structure-init.png)
...
![](/oss/github/javaguide/java/concurrent/aqs-addWaiter.png)
...
![](/oss/github/javaguide/java/concurrent/aqs-acquire-and-release-process.png)
...
![](/oss/github/javaguide/java/concurrent/aqs-acquire-and-release-process-2.png)
...
![](/oss/github/javaguide/java/concurrent/aqs-acquire-and-release-process-3.png)
...
![](/oss/github/javaguide/java/concurrent/aqs-acquire-and-release-process-4.png)

此时，假设线程 `T2` 释放锁，会唤醒后继节点 `T3` 。线程 `T3` 获取到锁之后，同样也退出等待队列，即将线程 `T3` 节点变为 `head` 节点来退出资源获取的等待。此时 AQS 内部队列如下所示：

![](/oss/github/javaguide/java/concurrent/aqs-acquire-and-release-process-5.png)
