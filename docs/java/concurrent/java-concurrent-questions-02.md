...
![JMM(Java 内存模型)](/oss/github/javaguide/java/concurrent/jmm.png)

![JMM(Java 内存模型)强制在主存中进行读取](/oss/github/javaguide/java/concurrent/jmm2.png)
...
![JUC原子类概览](/oss/github/javaguide/java/JUC%E5%8E%9F%E5%AD%90%E7%B1%BB%E6%A6%82%E8%A7%88-20230814005211968.png)
...
![synchronized关键字原理](/oss/github/javaguide/java/concurrent/synchronized-principle.png)
...
![执行 monitorenter 获取锁](/oss/github/javaguide/java/concurrent/synchronized-get-lock-code-block.png)

对象锁的拥有者线程才可以执行 `monitorexit` 指令来释放锁。在执行 `monitorexit` 指令后，将锁计数器设为 0，表明锁被释放，其他线程可以尝试获取锁。

![执行 monitorexit 释放锁](/oss/github/javaguide/java/concurrent/synchronized-release-lock-block.png)
...
![synchronized关键字原理](/oss/github/javaguide/synchronized%E5%85%B3%E9%94%AE%E5%AD%97%E5%8E%9F%E7%90%862.png)
...
![](/oss/github/javaguide/java/concurrent/reentrantlock-class-diagram.png)
...
![](/oss/github/javaguide/java/concurrent/reentrantreadwritelock-class-diagram.png)
