...
![ThreadLocal 数据结构](/oss/github/javaguide/java/concurrent/threadlocal-data-structure.png)

`ThreadLocalMap`是`ThreadLocal`的静态内部类。

![ThreadLocal内部类](/oss/github/javaguide/java/concurrent/thread-local-inner-class.png)
...
![TTL 官方提供的 CRR 整个过程的时序图](/oss/github/javaguide/java/concurrent/ttl-crr-timing-diagram.png)
...
![调整阻塞队列大小和最大线程数](/oss/github/javaguide/java/concurrent/threadpool-reject-2-threadpool-reject-01.png)
...
![将一部分任务保存到MySQL中](/oss/github/javaguide/java/concurrent/threadpool-reject-2-threadpool-reject-02.png)
...
![](/oss/github/javaguide/java/concurrent/threadpoolexecutor-methods.png)
...
![动态配置线程池参数最终效果](/oss/github/javaguide/java/concurrent/meituan-dynamically-configuring-thread-pool-parameters.png)
...
![ThreadPoolExecutor构造函数](/oss/github/javaguide/java/concurrent/common-parameters-of-threadpool-workqueue.jpg)
...
![](/oss/github/javaguide/java/concurrent/completablefuture-class-diagram.jpg)
...
![](/oss/javaguide/image-20210902093026059.png)
...
![CLH 锁的队列结构](/oss/github/javaguide/open-source-project/clh-lock-queue-structure.png)
...
![CLH 变体队列结构](/oss/github/javaguide/java/concurrent/clh-queue-structure-bianti.png)

AQS(`AbstractQueuedSynchronizer`)的核心原理图：

![CLH 变体队列](/oss/github/javaguide/java/concurrent/clh-queue-state.png)
