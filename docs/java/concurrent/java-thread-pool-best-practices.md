...
![](/oss/github/javaguide/java/concurrent/threadpool-methods-information.png)
...
![案例代码概览](/oss/github/javaguide/java/concurrent/production-accident-threadpool-sharing-example.png)
...
![线程池使用不当导致死锁](/oss/github/javaguide/java/concurrent/production-accident-threadpool-sharing-deadlock.png)
