...
![运行在 Java 虚拟机之上的编程语言](/oss/github/javaguide/java/basis/java-virtual-machine-program-language-os.png)
...
![](/oss/github/javaguide/java/basis/JavaSeSpecifications.jpg)
...
![jdk-include-jre](/oss/github/javaguide/java/basis/jdk-include-jre.png)
...
![Java程序转变为机器代码的过程](/oss/github/javaguide/java/basis/java-code-to-machine-code.png)
...
![Java程序转变为机器代码的过程](/oss/github/javaguide/java/basis/java-code-to-machine-code-with-jit.png)

> HotSpot 采用了惰性评估(Lazy Evaluation)的做法，根据二八定律，消耗大部分系统资源的只有那一小部分的代码（热点代码），而这也就是 JIT 所需要编译的部分。JVM 会根据代码每次被执行的情况收集信息并相应地做出一些优化，因此执行的次数越多，它的速度就越快。

JDK、JRE、JVM、JIT 这四者的关系如下图所示。

![JDK、JRE、JVM、JIT 这四者的关系](/oss/github/javaguide/java/basis/jdk-jre-jvm-jit.png)

下面这张图是 JVM 的大致结构模型。

![JVM 的大致结构模型](/oss/github/javaguide/java/basis/jvm-rough-structure-model.png)
...
![编译型语言和解释型语言](/oss/github/javaguide/java/basis/compiled-and-interpreted-languages.png)
...
<img src="/oss/github/javaguide/java/basis/jit-vs-aot.png" alt="JIT vs AOT" style="zoom: 25%;" />
...
![oracle jdk release cadence](/oss/github/javaguide/java/basis/oracle-jdk-release-cadence.jpg)
...
![](/oss/github/javaguide/java/basis/image-20220714112336911.png)
...
![](/oss/github/javaguide/up-1ae0425ce8646adfb768b5374951eeb820d.png)
...
![](/oss/github/javaguide/java/basis/java-basis-variables-member-variable-vs-local-variable.png)
...
![](/oss/github/javaguide/java/basis/java-basis-variables-static-variable.png)
