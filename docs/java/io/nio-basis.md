...
![BIO、NIO 和 AIO 对比](/oss/github/javaguide/java/nio/bio-aio-nio.png)
...
![Buffer、Channel和Selector三者之间的关系](/oss/github/javaguide/java/nio/channel-buffer-selector.png)
...
![Buffer 的子类](/oss/github/javaguide/java/nio/buffer-subclasses.png)
...
![position 、limit 和 capacity 之前的关系](/oss/github/javaguide/java/nio/JavaNIOBuffer.png)

![position 、limit 和 capacity 之前的关系](/oss/github/javaguide/java/nio/NIOBufferClassAttributes.png)
...
![capacity、limit和position每一阶段的变化](/oss/github/javaguide/java/nio/NIOBufferClassAttributesDataChanges.png)
...
![Channel 和 Buffer之间的关系](/oss/github/javaguide/java/nio/channel-buffer.png)

另外，因为 Channel 是全双工的，所以它可以比流更好地映射底层操作系统的 API。特别是在 UNIX 网络编程模型中，底层操作系统的通道都是全双工的，同时支持读写操作。

`Channel` 的子类如下图所示。

![Channel 的子类](/oss/github/javaguide/java/nio/channel-subclasses.png)
...
![Channel继承关系图](/oss/github/javaguide/java/nio/channel-inheritance-relationship.png)
...
![Selector 选择器工作示意图](/oss/github/javaguide/java/nio/selector-channel-selectionkey.png)
