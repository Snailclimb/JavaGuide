...
![](/oss/github/javaguide/java/new-features/jdk22-new-features.png)
...
![Markdown 文档注释](/oss/github/javaguide/java/new-features/jep467-markdown-documentation-comments.png)
