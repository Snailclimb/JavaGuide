...
![](./images/generated/mysql20210513092328171.png)

但是！哈希算法有个 **Hash 冲突** 问题，也就是说多个不同的 key 最后得到的 index 相同。通常情况下，我们常用的解决办法是 **链地址法**。链地址法就是将哈希冲突数据存放在链表中。就比如 JDK1.8 之前 `HashMap` 就是通过链地址法来解决哈希冲突的。不过，JDK1.8 以后`HashMap`为了减少链表过长的时候搜索时间过长引入了红黑树。

![](./images/generated/mysql20210513092224836.png)
...
![AVL 树](./images/generated/avl-tree.png)
...
![红黑树](./images/generated/red-black-tree.png)
...
![主键索引](./images/generated/cluster-index.png)
...
![二级索引](./images/generated/no-cluster-index.png)
...
![MySQL 表的文件](./images/generated/mysql20210420165311654.png)

聚簇索引和非聚簇索引:

![聚簇索引和非聚簇索引](./images/generated/mysql20210420165326946.png)
...
![覆盖索引](./images/generated/mysql20210420165341868.png)
...
![](./images/generated/not-using-covering-index-demo.png)
...
![](./images/generated/using-covering-index-demo.png)
