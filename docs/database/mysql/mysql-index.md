...
![](/oss/github/javaguide/database/mysql20210513092328171.png)
...
![](/oss/github/javaguide/database/mysql20210513092224836.png)
...
![](/oss/github/javaguide/cs-basics/data-structure/avl-tree.png)
...
![红黑树](/oss/github/javaguide/cs-basics/data-structure/red-black-tree.png)
...
![主键索引](/oss/github/javaguide/open-source-project/cluster-index.png)
...
![二级索引](/oss/github/javaguide/open-source-project/no-cluster-index.png)
...
![MySQL 表的文件](/oss/github/javaguide/database/mysql20210420165311654.png)

聚簇索引和非聚簇索引：

![聚簇索引和非聚簇索引](/oss/github/javaguide/database/mysql20210420165326946.png)
...
![覆盖索引](/oss/github/javaguide/database/mysql20210420165341868.png)
...
![](/oss/github/javaguide/mysql/not-using-covering-index-demo.png)
...
![](/oss/github/javaguide/mysql/using-covering-index-demo.png)
...
![](/oss/github/javaguide/database/mysql/index-condition-pushdown.png)

![](/oss/github/javaguide/database/mysql/index-condition-pushdown-graphic-illustration.png)
