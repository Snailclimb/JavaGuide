...
![关系型数据库表关系](/oss/java-guide-blog/5e3c1a71724a38245aa43b02_99bf70d46cc247be878de9d3a88f0c44.png)
...
![](/oss/github/javaguide/csdn/20210327143351823.png)
...
![MySQL 常见字段类型总结](/oss/github/javaguide/mysql/summary-of-mysql-field-types.png)
...
![查看 MySQL 提供的所有存储引擎](/oss/github/javaguide/mysql/image-20220510105408703.png)
...
![](/oss/github/javaguide/mysql/image-20220510155143458.png)
...
![MySQL architecture diagram showing connectors, interfaces, pluggable storage engines, the file system with files and logs.](/oss/github/javaguide/mysql/mysql-architecture.png)
...
![](/oss/github/javaguide/mysql/image-20220510090309427.png)
...
![InnoDB 和 MyISAM 性能对比](/oss/github/javaguide/mysql/innodb-myisam-performance-comparison.png)
...
![常见的几种 MySQL 存储引擎对比](/oss/github/javaguide/mysql/comparison-of-common-mysql-storage-engines.png)
...
![](/oss/github/javaguide/database/mysql/leftmost-prefix-matching-rule.png)
...
![MySQL 8.0: Retiring Support for the Query Cache](/oss/github/javaguide/mysql/mysql8.0-retiring-support-for-the-query-cache.png)
...
![数据库事务示意图](/oss/github/javaguide/mysql/%E6%95%B0%E6%8D%AE%E5%BA%93%E4%BA%8B%E5%8A%A1%E7%A4%BA%E6%84%8F%E5%9B%BE.png)

另外，关系型数据库（例如：`MySQL`、`SQL Server`、`Oracle` 等）事务都有 **ACID** 特性：

![ACID](/oss/github/javaguide/mysql/ACID.png)
...
![脏读](/oss/github/javaguide/database/mysql/concurrency-consistency-issues-dirty-reading.png)
...
![丢失修改](/oss/github/javaguide/database/mysql/concurrency-consistency-issues-missing-modifications.png)
...
![不可重复读](/oss/github/javaguide/database/mysql/concurrency-consistency-issues-unrepeatable-read.png)
...
![幻读](/oss/github/javaguide/database/mysql/concurrency-consistency-issues-phantom-read.png)
...
![](/oss/github/javaguide/mysql/image-20220511171419081.png)
...
![](/oss/github/javaguide/mysql/oss-search.png)
...
![常见的 SQL 优化手段](/oss/javamianshizhibei/javamianshizhibei-sql-optimization.png)
