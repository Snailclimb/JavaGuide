...
![复合索引](/oss/github/javaguide/database/mongodb/mongodb-composite-index.png)
...
![](/oss/github/javaguide/database/mongodb/replica-set-read-write-operations-primary.png)
...
![](/oss/github/javaguide/database/mongodb/replica-set-primary-with-two-secondaries.png)
...
![](/oss/github/javaguide/database/mongodb/sharded-cluster-production-architecture.png)
...
![](/oss/github/javaguide/database/mongodb/example-of-scope-based-sharding.png)
...
![](/oss/github/javaguide/database/mongodb/example-of-hash-based-sharding.png)
...
![Chunk 分裂](/oss/github/javaguide/database/mongodb/chunk-splitting-shard-a.png)
...
![Chunk 迁移](/oss/github/javaguide/database/mongodb/mongo-reblance-three-shards.png)
