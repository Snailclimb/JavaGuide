...
![MongoDB 文档](/oss/github/javaguide/database/mongodb/crud-annotated-document..png)
...
![BSON 官网首页](/oss/github/javaguide/database/mongodb/bsonspec.org.png)

#### 集合

MongoDB 集合存在于数据库中，**没有固定的结构**，也就是 **无模式** 的，这意味着可以往集合插入不同格式和类型的数据。不过，通常情况下，插入集合中的数据都会有一定的关联性。

![MongoDB 集合](/oss/github/javaguide/database/mongodb/crud-annotated-collection.png)
...
![WiredTiger B+树整体结构](/oss/github/javaguide/database/mongodb/mongodb-b-plus-tree-integral-structure.png)
...
![管道的工作流程](/oss/github/javaguide/database/mongodb/mongodb-aggregation-stage.png)
