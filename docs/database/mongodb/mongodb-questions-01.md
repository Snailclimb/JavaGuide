...
![MongoDB 文档](./images/generated/crud-annotated-document..png)
...
![BSON 官网首页](./images/generated/bsonspec.org.png)

#### 集合

MongoDB 集合存在于数据库中，**没有固定的结构**，也就是 **无模式** 的，这意味着可以往集合插入不同格式和类型的数据。不过，通常情况下，插入集合中的数据都会有一定的关联性。

![MongoDB 集合](./images/generated/crud-annotated-collection.png)
...
![WiredTiger B+树整体结构](./images/generated/mongodb-b-plus-tree-integral-structure.png)
...
![管道的工作流程](./images/generated/mongodb-aggregation-stage.png)
