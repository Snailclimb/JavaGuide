...
![](/oss/github/javaguide/database/redis/redis4.0-persitence.png)
...
![Redis 持久化机制完整流程](/oss/github/javaguide/database/redis/redis-persistence-flow.png)
...
![AOF 工作基本流程](/oss/github/javaguide/database/redis/aof-work-process.png)
...
![AOF 记录日志过程](/oss/github/javaguide/database/redis/redis-aof-write-log-disc.png)
...
![AOF 重写](/oss/github/javaguide/database/redis/aof-rewrite.png)
