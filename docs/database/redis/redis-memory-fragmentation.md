...
![内存碎片](/oss/github/javaguide/memory-fragmentation.png)
...
![jemalloc 内存单元示意图](/oss/github/javaguide/database/redis/6803d3929e3e46c1b1c9d0bb9ee8e717.png)
...
![](/oss/github/javaguide/redis-docs-memory-optimization.png)
...
![](/oss/github/javaguide/redis-info-memory.png)
