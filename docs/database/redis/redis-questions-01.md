...
![Redis 数据类型概览](/oss/github/javaguide/database/redis/redis-overview-of-data-types-2023-09-28.jpg)

Redis 没有外部依赖，Linux 和 OS X 是 Redis 开发和测试最多的两个操作系统，官方推荐生产环境使用 Linux 部署 Redis。

个人学习的话，你可以自己本机安装 Redis 或者通过 Redis 官网提供的[在线 Redis 环境](https://try.redis.io/)（少部分命令无法使用）来实际体验 Redis。

![try-redis](/oss/github/javaguide/database/redis/try.redis.io.png)
...
![why-redis-so-fast](/oss/github/javaguide/database/redis/why-redis-so-fast.png)
...
![Hash维护简单的购物车信息](/oss/github/javaguide/database/redis/hash-shopping-cart.png)
...
![](/oss/github/javaguide/database/redis/2021060714195385.png)
...
![](/oss/github/javaguide/database/redis/image-20220719071115140.png)
...
![img](/oss/github/javaguide/database/redis/image-20220720194154133.png)
...
![文件事件处理器（file event handler）](/oss/github/javaguide/database/redis/redis-event-handler.png)
...
![redis4.0 more thread](/oss/github/javaguide/database/redis/redis4.0-more-thread.png)
...
![Redis 过期字典](/oss/github/javaguide/database/redis/redis-expired-dictionary.png)
...
![redis.conf 对于 hz 的注释](/oss/github/javaguide/database/redis/redis.conf-hz.png)
