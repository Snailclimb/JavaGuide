...
- 《Java 并发编程核心 78 讲》
- Easy to understand pessimistic lock, optimistic lock, reentrant lock, spin lock, bias lock, lightweight/heavyweight lock, read-write lock, various locks and their Java implementation! ：<https://zhuanlan.zhihu.com/p/71156910>
