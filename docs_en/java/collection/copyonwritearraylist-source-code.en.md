...
```plain
The updated list is: [Java, Golang]
After inserting elements into the list: [PHP, Java, Golang]
List size is: 3
Batch delete results: true
After deleting elements in batches from the list: [PHP]
