...
- [What do I think about when I refactor](https://mp.weixin.qq.com/s/pFaFKMXzNCOuW2SD9Co40g): This article from Zhuanzhuan Technology summarizes common refactoring scenarios and refactoring methods.
- [Refactoring Practical Exercise](https://linesh.gitbook.io/refactoring/): Learn refactoring step by step through several small cases!
- [Design Pattern + Refactoring Learning Website](https://refactoringguru.cn/): Free online learning of code refactoring, design patterns, and SOLID principles (single responsibility, open-close principle, Liskov substitution, interface isolation, and dependency inversion).
- [IDEA official document code refactoring tutorial](https://www.jetbrains.com/help/idea/refactoring-source-code.html#popular-refactorings): Teach you how to use IDEA for refactoring.

## Reference

- [Reread "Refactoring" - ThoughtWorks Insights - 2020](https://insights.thoughtworks.cn/reread-refactoring/): Detailed introduction to the key points of refactoring such as small-step refactoring and garbage-picking refactoring, mainly introducing the concept of refactoring.
- [Common code refactoring techniques - VectorJin - 2021](https://juejin.cn/post/6954378167947624484): It introduces how to refactor from the perspectives of software design principles, design patterns, code layering, naming conventions, etc., which is more practical.
