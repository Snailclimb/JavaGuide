...
Here are some personal suggestions for unit testing:

> - The more important the code, the more unit tests need to be written;
> - The code cannot be unit tested, think more about how to improve it instead of giving up;
> - Write business code and unit tests while writing, rather than writing after completing the entire new function;
> - Think more about how to improve and simplify the test code.
> - Test code needs to be refactored or modified as the production code evolves. If the test cannot be kept clean, it will only become more and more difficult to modify.

As an experienced programmer, writing unit tests is more about being responsible for your own code. Code with test cases is easier for others to understand. When others take over your code in the future, they may feel free to make changes.

**Practice coding more and communicate more with engineers who have experience in unit testing**, you will find that you will gain more benefits from writing unit tests.
