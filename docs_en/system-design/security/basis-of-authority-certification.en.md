...
- **New system development perspective:** When developing a new system, you only need to directly connect to the unified account center, simplifying the development process and saving time.

## How to design and implement an SSO system?

[SSO single sign-on detailed explanation](./sso-intro.md)

## What is OAuth 2.0?

OAuth is an industry standard authorization protocol, mainly used to authorize third-party applications to obtain limited permissions. While OAuth 2.0 is a complete redesign of OAuth 1.0, OAuth 2.0 is faster and easier to implement. OAuth 1.0 has been deprecated. For details, see: [rfc6749](https://tools.ietf.org/html/rfc6749).

In fact, it is an authorization mechanism, and its ultimate purpose is to issue a time-sensitive token to third-party applications, so that third-party applications can obtain related resources through the token.

The most common scenario of OAuth 2.0 is third-party login. When your website is connected to third-party login, the OAuth 2.0 protocol is generally used.

In addition, OAuth 2.0 is now also commonly used in payment scenarios (WeChat payment, Alipay payment) and development platforms (WeChat open platform, Alibaba open platform, etc.).

The picture below is a diagram of [Slack OAuth 2.0 third-party login](https://api.slack.com/legacy/oauth):

![](https://oss.javaguide.cn/github/javaguide/system-design/security/20210615151716340.png)

**Recommended Reading:**

- [A simple explanation of OAuth 2.0](http://www.ruanyifeng.com/blog/2019/04/oauth_design.html)
- [10 minutes to understand what is OAuth 2.0 protocol](https://deepzz.com/post/what-is-oauth2-protocol.html)
- [Four ways of OAuth 2.0](http://www.ruanyifeng.com/blog/2019/04/oauth-grant-types.html)
- [GitHub OAuth third-party login sample tutorial](http://www.ruanyifeng.com/blog/2019/04/github-oauth.html)

## Reference

- Don’t use JWT to replace session management (Part 1): Comprehensive understanding of Token, JWT, OAuth, SAML, SSO: <https://zhuanlan.zhihu.com/p/38942172>
